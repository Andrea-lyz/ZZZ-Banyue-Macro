...
一款专为绝区零角色「般岳」设计的 AutoHotkey v2 宏脚本。v3 版本在 v2 的双模式系统基础上，新增了**可视化按键显示 GUI**，支持实时显示按键状态和连招详情，极大地方便了视频录制和教学演示。

## 🌟 v3.0 新特性
- **可视化按键悬浮窗**：新增按键显示 GUI，实时反馈物理按键操作（1234/QE/Shift/Space/鼠标键），支持拖动。
